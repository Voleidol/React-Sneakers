    ...
    <div className="wrapper clear">
      ...
      <div className="overlay">
        <div className="drawer">
          ...
          <h2 className="mb-30 d-flex justify-between">Корзина <img className="removeBtn cu-p" src="/icons/Remove.svg" alt="Remove" /></h2>
          ...
          <div className="cartTotalBlock">
            ...
            <button className="greenButton">Оформить заказ <img src="/icons/arrow.svg" alt="Arrow" /></button>
